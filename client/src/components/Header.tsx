  ...
  return (
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
        <div className="text-center mt-20 mb-8">
            <div className="inline-flex items-center justify-center gap-3.5 px-6 py-1.5 mb-4 border
        ...
        <div className="text-center">
            {input && <button onClick={onClear} className="bg-primary/10 text-primary px-3 py-2 rounded-lg hover:scale-105 
            transition-all cursor-pointer text-sm">Clear Search</button>}
        </div>
